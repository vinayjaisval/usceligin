...
class Product extends Model
{
    ...
    /**
     * Scope a query to only include products that match the current language.
     *
     * If the language is 'kr', only products with language 'kr' are included.
     * If the language is not 'kr', only products with language null or not 'kr' are included.
     *
