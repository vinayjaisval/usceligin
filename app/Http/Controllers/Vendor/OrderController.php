...
{ 
    ...
    public function orders(Request $request)
    {
        ...
        //     return view('vendor.orderpos.pending');
        // } else if ($request->status == 'processing') {
        //     return view('vendor.orderpos.processing');
        // } else if ($request->status == 'completed') {
        //     return view('vendor.orderpos.completed');
        // } else if ($request->status == 'declined') {
        //     return view('vendor.orderpos.declined');
        // } else {
    ...
    public function datatables()
    {
        ...
        // }
        $datas = Order::where('seller_id' , $user->id)->latest('id')->get();
        //--- Integrating This Collection Into Datatables
        return Datatables::of($datas)
            ->editColumn('id', function (Order $data) {
                $id = '<a href="' . route('vendor-order-invoice', $data->id) . '">' . $data->order_number . '</a>';
                return $id;
            })
    ...
    public function invoice($id)
    {
        $order = Order::findOrFail($id);
        $cart = json_decode($order->cart, true);
        return view('vendor.orderpos.invoice', compact('order', 'cart'));
    }
    ...
    public function printpage($id)
    {
        $order = Order::findOrFail($id);
        $cart = json_decode($order->cart, true);
        return view('vendor.orderpos.print', compact('order', 'cart'));
    }
    ...
    {
        $data = Order::find($id);
        return view('vendor.orderpos.delivery', compact('data'));
    }
    ...
    public function product_show($id)
    {
        ...
        $data['curr'] = $this->curr;
        return view('vendor.orderpos.add-product', $data);
    }
    ...
    public function product_edit($id, $itemid, $orderid)
    {
        ...
        return view('vendor.orderpos.edit-product', $data);
    }
