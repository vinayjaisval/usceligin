...
class OrderTrackController extends VendorBaseController
{
   ...
   //*** GET Request
    public function index($id)
    {
        ...
        return view('vendor.orderpos.track',compact('order'));
    }
   ...
   //*** GET Request
    ...
    {
        $order = Order::findOrFail($id);
        return view('vendor.orderpos.track-load',compact('order'));
    }
