    ...
    public function datatables()
    {
        ...
        return Datatables::of($datas)
            ->addColumn('status', function (Category $data) {
                ...
                $ns1 = $data->status == 2 ? 'selected' : '';
                return '<div class="action-list">
                <select class="process select droplinks ' . $class . '">
                <option data-val="1" value="' . route('admin-cat-status', ['id1' => $data->id, 'id2' => 1]) . '" ' . $s . '>
                ' . __("Activated") . '</option>
                <option data-val="0" value="' . route('admin-cat-status', ['id1' => $data->id, 'id2' => 0]) . '" ' . $ns . '>' . __("Deactivated") . '</option>
                <option data-val="2" value="' . route('admin-cat-status', ['id1' => $data->id, 'id2' => 2]) . '" ' . $ns1 . '>' . __("How-to-use") . '</option>
                </select></div>';
            })
            ->editColumn('is_featured', function (Category $data) {
                ...
                return '<div class="action-list"><select class="process select droplinks ' . $class . '"><option data-val="1" value="' . route('admin-cat-featured', ['id1' => $data->id, 'id2' => 1]) . '" ' . $s . '>' . __("Activateds") . '</option><option data-val="0" value="' . route('admin-cat-featured', ['id1' => $data->id, 'id2' => 0]) . '" ' . $ns . '>' . __("Deactivated") . '</option>/select></div>';
            })
