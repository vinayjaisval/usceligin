...
class LanguageController extends AdminBaseController
{
    ...
    {
        $lang = json_decode(file_get_contents(url('/resources/lang/default.json')), true);
    ...
    public function export($id)
    {
        ...
        return response()->download(public_path('public_html/assets/temp_files/language.csv'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
        $data = Language::findOrFail($id);
        if (file_exists('/public_html/resources/lang/' . $data->file)) {
            unlink('/public_html/resources/lang/' . $data->file);
        }
        $data->language = $input['language'];
        $data->rtl = $input['rtl'];
        $data->update();
        ...
        $mydata = json_encode($new);
        // dd($mydata);
        $folder = 'public_html/resources/lang/';
    ...
    public function destroy($id)
    {
        ...
        if (file_exists(public_path() . '/public_html/resources/lang/' . $data->file)) {
            unlink(public_path() . '/public_html/resources/lang/' . $data->file);
        }
