...
class OrderUserController extends UserBaseController
{
    //*** GET Request
    public function orders(Request $request)
    {
        if ($request->status == 'pending') {
            return view('user.order_pos.pending');
        } else if ($request->status == 'processing') {
            return view('user.order_pos.processing');
        } else if ($request->status == 'completed') {
            return view('user.order_pos.completed');
        } else if ($request->status == 'declined') {
            return view('user.order_pos.declined');
        } else {
            return view('user.order_pos.index');
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('user.order_pos.details', compact('order', 'cart'));
    }
    ...
    public function invoice($id)
    {
        $order = Order::findOrFail($id);
        $cart = json_decode($order->cart, true);
        return view('user.order_pos.invoice', compact('order', 'cart'));
    }
    ...
    public function printpage($id)
    {
        $order = Order::findOrFail($id);
        $cart = json_decode($order->cart, true);
        return view('user.order_pos.print', compact('order', 'cart'));
    }
    ...
    {
        $data = Order::find($id);
        return view('user.order_pos.delivery', compact('data'));
    }
    ...
    public function product_show($id)
    {
        ...
        $data['curr'] = $this->curr;
        return view('user.order_pos.add-product', $data);
    }
    ...
    public function product_edit($id, $itemid, $orderid)
    {
        ...
        return view('user.order_pos.edit-product', $data);
    }
