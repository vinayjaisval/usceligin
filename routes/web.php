...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:orders'], function () {
        ...
        // Influencer
        Route::get('/influencer-list/datatables', 'Admin\UserController@datatablesinfluencer')->name('influencer-list-datatables'); //JSON REQUEST
        Route::get('influencer-list', 'Admin\UserController@influencerList')->name('influencer-list');
        Route::get('influencer/sync-to-user/{id}', 'Admin\UserController@syncToUser')->name('sync-to-user');
        Route::get('make-influencer-user-affilated/{id}', 'Admin\UserController@makeInfluencerAffilated')->name('admin-user-make-affiliate');
    ...
    Route::group(['middleware' => 'permissions:products'], function () {
        ...
        // cosmatic combo 
        Route::get('/products/cosmatic-combo', 'Admin\CeliginComboController@index')->name('cosmatic-combo');
        Route::get('/products/cosmatic-combo-datatable', 'Admin\CeliginComboController@datatables')->name('admin-celigin-combo-datatables');
        Route::get('admin-celigin-combo-create', 'Admin\CeliginComboController@create')->name('admin-celigin-combo-create');
        Route::post('admin-celigin-combo-store', 'Admin\CeliginComboController@store')->name('admin-celigin-combo-store');
        Route::get('admin-celigin-combo-edit/{id}', 'Admin\CeliginComboController@edit')->name('admin-celigin-combo-edit');
        Route::post('admin-celigin-combo-update/{id}', 'Admin\CeliginComboController@update')->name('admin-celigin-combo-update');
        Route::delete('admin-celigin-combo-delete/{id}', 'Admin\CeliginComboController@destroy')->name('admin-celigin-combo-delete');
    });

    Route::group(['middleware' => 'permissions:productskr'], function () {

        Route::get('/productskr/datatables', 'Admin\ProductkrController@datatables')->name('admin-prod-datatables-kr'); //JSON REQUEST
        Route::get('/productskr', 'Admin\ProductkrController@index')->name('admin-prod-index-kr');

        Route::post('/productskr/upload/update/{id}', 'Admin\ProductkrController@uploadUpdate')->name('admin-prod-upload-update-kr');

        Route::get('/productskr/deactive', 'Admin\ProductkrController@deactive')->name('admin-prod-deactive-kr');

        Route::get('/productskr/catalogs/datatables', 'Admin\ProductkrController@catalogdatatables')->name('admin-prod-catalog-datatables-kr'); //JSON REQUEST
        Route::get('/productskr/catalogs/', 'Admin\ProductkrController@productscatalog')->name('admin-prod-catalog-index-kr');

        // CREATE SECTION
        Route::get('/productskr/types', 'Admin\ProductkrController@types')->name('admin-prod-types-kr');
        Route::get('/productskr/{slug}/create', 'Admin\ProductkrController@create')->name('admin-prod-create-kr');
        Route::post('/productskr/store', 'Admin\ProductkrController@store')->name('admin-prod-store-kr');
        Route::get('/getattributeskr', 'Admin\ProductkrController@getAttributes')->name('admin-prod-getattributes-kr');
        Route::get('/get/crossproduct/{catid}', 'Admin\ProductkrController@getCrossProduct');
        // CREATE SECTION

        // EDIT SECTION
        Route::get('/productskr/edit/{id}', 'Admin\ProductkrController@edit')->name('admin-prod-edit-kr');
        Route::post('/productskr/edit/{id}', 'Admin\ProductkrController@update')->name('admin-prod-update-kr');
        // EDIT SECTION ENDS

        // DELETE SECTION
        Route::delete('/productskr/delete/{id}', 'Admin\ProductkrController@destroy')->name('admin-prod-delete-kr');
        // DELETE SECTION ENDS

        Route::get('/productskr/catalog/{id1}/{id2}', 'Admin\ProductkrController@catalog')->name('admin-prod-catalog-kr');

        Route::get('/productskr/product-settings', 'Admin\ProductkrController@productsettings')->name('admin-gs-prod-settings-kr');
        Route::post('/productskr/product-settings/update', 'Admin\ProductkrController@settingUpdate')->name('admin-gs-prod-settings-update-kr');

        // cosmatic combo 
        Route::get('/productskr/cosmatic-combo', 'Admin\CeliginComboController@index')->name('cosmatic-combo-kr');
        Route::get('/productskr/cosmatic-combo-datatable', 'Admin\CeliginComboController@datatables')->name('admin-celigin-combo-datatables');
        Route::get('admin-celigin-combo-create', 'Admin\CeliginComboController@create')->name('admin-celigin-combo-create');
        Route::post('admin-celigin-combo-store', 'Admin\CeliginComboController@store')->name('admin-celigin-combo-store');
        Route::get('admin-celigin-combo-edit/{id}', 'Admin\CeliginComboController@edit')->name('admin-celigin-combo-edit');
        Route::post('admin-celigin-combo-update/{id}', 'Admin\CeliginComboController@update')->name('admin-celigin-combo-update');
    ...
    Route::group(['middleware' => 'permissions:customers'], function () {
        ...
        Route::get('/affiliate-users/datatables', 'Admin\UserController@datatabless')->name('affiliate-admin-user-datatables'); //JSON REQUEST

        Route::get('/users', 'Admin\UserController@index')->name('admin-user-index');
        Route::get('/affiliate-users', 'Admin\UserController@indexx')->name('affiliate-admin-user-index');
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::prefix('vendor')->group(function () {
        ...
        Route::get('/orders', 'Vendor\OrderController@orders')->name('vendor-order-index');
        ...
        Route::get('/ordercart/product-edit/{id}/{itemid}/{orderid}', 'Vendor\OrderController@product_edit')->name('vendor-order-product-edit');
        Route::get('/order/updatecart/{id}', 'Vendor\OrderController@updatecart');
        Route::get('/ordercart/product-delete/{id}/{orderid}', 'Vendor\OrderController@product_delete')->name('vendor-order-product-delete'); 
        ...
        Route::get('/order/product/datatables', 'Vendor\OrderCreateController@datatables')->name('vendor-order-product-datatables'); //JSON REQUEST
        Route::get('/order/create', 'Vendor\OrderCreateController@create')->name('vendor-order-create');
        Route::get('/order/product/add/{product_id}', 'Vendor\OrderCreateController@addProduct')->name('vendor-order-product-add');
        Route::get('/order/product/add', 'Vendor\OrderCreateController@orderStore')->name('vendor.order.store.new');
        Route::get('/order/product/remove/{product_id}', 'Vendor\OrderCreateController@removeOrderProduct')->name('vendor.order.product.remove');
        Route::get('/order/create/product-show/{id}', 'Vendor\OrderCreateController@product_show');
        Route::get('/order/create/addcart/{id}', 'Vendor\OrderCreateController@addcart');
        ...
        Route::delete('/order/track/delete/{id}', 'Vendor\OrderTrackController@delete')->name('vendor-order-track-delete');



        Route::get('/mlm-user', 'Vendor\VendorController@mlm_users')->name('vendor-mlm-users');
    ...
    Route::prefix('user')->group(function () {
        ...
        // Route::get('/verify-otp', 'User\LoginController@showLoginForm')->name('verify-otp');
        ...
        Route::get('/address_add', 'User\UserController@address_add')->name('user-address-add');
        Route::post('/address_store', 'User\UserController@address_store')->name('user-address-store');
        Route::delete('/address_delete/{id}', 'User\UserController@address_delete')->name('user-address-delete');

        Route::get('/address_edit/{id}', 'User\UserController@address_edit')->name('user-address-edit');
        // Route::post('/address_update/{id}', 'User\UserController@address_update')->name('user-address-update');
    ...
    Route::middleware(['Translate'])->group(function () {
        ...
        Route::get('/landdingpage', 'Front\FrontendController@landdingpage')->name('front.landdingpage');
        ...
        Route::get('/how-to-use/{slug?}', 'Front\FrontendController@how_to_use')->name('front.how-to-use');
        Route::get('skincare/live-diagnostics', 'Front\FrontendController@livediagnostics')->name('front.livediagnostics');
        ...
        // cell for eduction 
        Route::get('/cell-for-education', 'Front\FrontendController@cell_for_education')->name('front.cell-for-education');
...
Route::post('/apply-coupon', 'Front\CouponController@applyCoupon')->name('applyCoupon');
