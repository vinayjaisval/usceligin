...
<div class="border border-gray-200 dark:border-gray-700 p-4 {{ $selected ? 'ring-2 ring-blue-600 dark:ring-blue-400 bg-blue-50 dark:bg-blue-900/10' : '' }} hover:border-gray-300 dark:hover:border-gray-600 transition-all cursor-pointer"
  ...
  <div class="flex items-start gap-3">
    ...
    <div class="flex-1 min-w-0">
      ...
      <div class="flex items-center gap-2 mb-1">
        ...
        <span class="px-2 py-0.5 text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200">
          Default
        </span>
        @endif
      </div>
