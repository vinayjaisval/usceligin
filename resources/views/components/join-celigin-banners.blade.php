...
<section class="py-12 lg:py-8 bg-white dark:bg-gray-900">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
      ...
      <div class="relative overflow-hidden group cursor-pointer">
        ...
        <div class="absolute inset-y-0 left-0 w-1/2 flex flex-col justify-center text-left p-6 sm:p-4 md:p-6 lg:p-8">
          <span
      ...
      <div class="relative overflow-hidden group cursor-pointer">
        <img src="{{ asset('assets/frontend/images/cell-education-banner.png') }}"
          ...
          class="w-full h-64 lg:h-80 object-cover group-hover:scale-105 transition-transform duration-300" />
        <div class="absolute inset-x-0 bottom-0 flex items-end justify-between p-6 sm:p-4 md:p-6 lg:p-8">
          <h3 class="text-xl sm:text-2xl lg:text-3xl font-bold text-black dark:text-white">
            Cell For Education
          </h3>
          <a href="{{ url('/education') }}"
            class="inline-flex items-center px-2 py-2 bg-orange-600 dark:bg-orange-500 text-white font-medium hover:bg-orange-700 dark:hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 transition-all duration-200 text-sm"
