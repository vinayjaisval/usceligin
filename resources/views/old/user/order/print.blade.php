        ...
        <div class="invoice__metaInfo" style="margin-top:0px;">
            ...
            <div class="col-lg-6" style="width:50%;">
                <div class="invoice__orderDetails" style="margin-top:5px;">
                    ...
                    <span><strong>{{ __('Customer Name') }}</strong>: {{ $shippingAddress->customer_name ?? 'N/A' }}</span><br>
                    <span><strong>{{ __('Address') }}</strong>: {{ $shippingAddress->address ?? 'N/A' }}</span><br>
                    <span><strong>{{ __('City') }}</strong>: {{ $shippingAddress->city ?? 'N/A' }} {{ $billingAddress->zip ?? 'N/A' }}</span><br>
                    <span><strong>{{ __('Country') }}</strong>: {{ $shippingAddress->country_id ?? 'N/A' }}</span>
                </div>
            </div>
            ...
            <div class="col-lg-6" style="width:50%;">
                <div class="invoice__orderDetails" style="margin-top:5px;">
                    ...
                    <span><strong>{{ __('Customer Name') }}</strong>: {{ $billingAddress->customer_name ?? 'N/A' }}</span><br>
                    <span><strong>{{ __('Address') }}</strong>: {{ $billingAddress->address ?? 'N/A' }}</span><br>
                    <span><strong>{{ __('City') }}</strong>: {{ $billingAddress->city ?? 'N/A' }} {{ $billingAddress->zip ?? 'N/A' }}</span><br>
                    <span><strong>{{ __('Country') }}</strong>: {{ $billingAddress->country_id ?? 'N/A' }}</span>
                </div>
            </div>
        </div>
