                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-8 pt-2">
                                                            ...
                                                            @if($user_affiliated_times >= 5)
                                                                ...
                                                                <div class="mt-3">
                                                                    <label><strong>Share your affiliate link:</strong></label><br>
                                                                    <a href="https://wa.me/?text={{ urlencode($affiliateUrl) }}" target="_blank" class="btn btn-success btn-sm mr-1">
                                                                        <i class="fab fa-whatsapp"></i> WhatsApp
                                                                    </a>
                                                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($affiliateUrl) }}" target="_blank" class="btn btn-primary btn-sm mr-1">
                                                                        <i class="fab fa-facebook-f"></i> Facebook
                                                                    </a>
                                                                    <a href="https://twitter.com/intent/tweet?url={{ urlencode($affiliateUrl) }}" target="_blank" class="btn btn-info btn-sm">
