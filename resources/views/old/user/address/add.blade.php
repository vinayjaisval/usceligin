                        ...
                        <div class="body">
                           <div class="edit-info-area-form">
                              ...
                              <form  action="{{route('user-address-store')}}" method="POST">
                                 ...
                                 <div class="row mb-4">
                                    <div class="col-lg-6">
                                       <input type="hidden" name="user_id" value="{{ $user->id }}" class="input-field form-control border">
                                 ...
                                 <div class="row mb-4 g-3">
                                       ...
                                       <div class="col-lg-6">
                                          <input name="flat_no" id="flat_no" type="text" class="input-field form-control border" placeholder="House No." value="">
                                       </div>

                                       <div class="col-lg-6">
                                          <input name="landmark" id="flat_no" type="text" class="input-field form-control border" placeholder="Landmark." value="">
                                       </div>
                                    </div>
