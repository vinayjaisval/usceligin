    <div class="cart-popup">
        <ul class="cart_list product_list_widget " style="overflow-y: scroll; max-height: 400px;">
            @if (Session::has('cart'))
        ...
        @else
        <a href="{{ route('loginotp') }}" class="btn btn-secondary rounded-0 checkout">{{ __('Check out') }}</a>
