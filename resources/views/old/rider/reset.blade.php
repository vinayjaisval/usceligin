                  ...
                  <div class="widget border-0 p-40 widget_categories bg-light account-info">
                     ...
                     <div class="body">
                        <div class="edit-info-area-form">
                           ...
                           <form id="userform" action="{{route('rider-reset-submit')}}" method="POST"
                              enctype="multipart/form-data">
                              @csrf
                              @include('alerts.admin.form-both')
                              <div class="row">
                                 <div class="col-lg-12 mb-4">
                                    <input type="password" name="cpass" class="form-control  border"
                                       placeholder="{{ __('Current Password') }}" value="" required="">
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col-lg-12 mb-4">
                                    <input type="password" name="newpass" class="input-field form-control  border"
                                       placeholder="{{ __('New Password') }}" value="" required="">
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col-lg-12 mb-4">
                                    <input type="password" name="renewpass" class="input-field form-control border"
                                       placeholder="{{ __('Re-Type New Password') }}" value="" required="">
                                 </div>
                              </div>
