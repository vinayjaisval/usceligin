     ...
     <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
        ...
        <tbody>
           ...
           <tr>
              ...
              <td>
                 <a href="javascript:;"  data-href="{{ route('vendor.order.remove.cart',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}" class="mybtn1 removeOrder"><i class="fa fa-trash"></i> {{ __('Remove') }}</a>
              </td>
           </tr>
           @endforeach
        </tbody>
