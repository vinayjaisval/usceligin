...
<div class="cart-btn">
      ...
      @if($productt->stock <= 0)
        <button type="button" class="addProductSubmit-btn1" disabled>
          {{ __('Out of Stock') }}
        </button>
      @else
...
let urlAdd = mainurl+"/vendor/order/create/addcart/"+order_id+"?id="+pid+"&qty="+qty+"&size="+sizes+"&color="+colors.substring(1, colors.length)+"&size_qty="+size_qty+"&size_price="+size_price+"&size_key="+size_key+"&keys="+keys+"&values="+values+"&prices="+prices;
