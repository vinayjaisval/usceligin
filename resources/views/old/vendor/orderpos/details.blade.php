            ...
            <div class="col-lg-6">
                <div class="special-box">
                    ...
                    <div class="footer-area">
                        <a href="{{ route('vendor-order-invoice',$order->id) }}" class="mybtn1"><i
                                    ...
                                    <td>
                                        ...
                                        <div class="action-list">
                                            ...
                                            <a class="add-btn edit-product"
                                                data-href="{{ route('vendor-order-product-edit',[$itemKey, $product['item']['id'],$order->id]) }}"
                                                data-toggle="modal" data-target="#edit-product-modal">
                                                <i class="fas fa-edit"></i> {{ __("Edit") }}
                                            </a>

                                            <a class="add-btn delete-product"
                                                data-href="{{ route('vendor-order-product-delete',[$itemKey,$order->id]) }}"
