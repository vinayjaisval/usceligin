...
<!-- 
<li>
    <a href="#menuv" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="icofont-cart"></i>{{ __('Products Kr') }}
    </a>
    <ul class="collapse list-unstyled" id="menuv" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-prod-types-kr') }}"><span>{{ __('Add New Product') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index-kr') }}"><span>{{ __('All Products') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-deactive-kr') }}"><span>{{ __('Deactivated Product') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-catalog-index-kr') }}"><span>{{ __('Product Catalogs') }}</span></a>
        </li>

        <li>
            <a href="{{ route('admin-gs-prod-settings-kr') }}"><span>{{ __('Product Settings') }}</span></a>
        </li>
    </ul>
</li> -->
<li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="menu3" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('affiliate-admin-user-index') }}"><span>{{ __('Affiliate Customers') }}</span></a>
        </li>
        <li>
...
<li>
    <a href="{{ route('influencer-list') }}"><i class="fas fa-list"></i>{{ __('Influencer List') }}</a>
</li>
...
<li>
    <a href="{{ route('mlm-users') }}" class="wave-effect"><i
            class="fa fa-user mr-2"></i>{{ __('Affiliate Users') }}</a>
</li>
