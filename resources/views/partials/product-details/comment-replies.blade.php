                ...
                @foreach($comments->latest() as $comment)
                  <li>
                    <div class="single-comment comment-section">
                      <div class="left-area">
                        <img src="{{$comment->user->photo != null ? asset('assets/images/users/'.$comment->user->photo) : asset('assets/images/'.$gs->user_image)}}" alt="">
                ...
                @if($comment->replies)
                  @foreach($comment->replies as $reply)
                    <div class="single-comment replay-review d-none">
                      <div class="left-area">
                        <img src="{{ $reply->user->photo != null ? asset('assets/images/users/'.$reply->user->photo) : asset('assets/images/'.$gs->user_image) }}" alt="">
