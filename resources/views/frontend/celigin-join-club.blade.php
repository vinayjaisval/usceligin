  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div class="mt-8 lg:mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 text-center">
          <span class="material-icons-outlined text-4xl text-orange-600 dark:text-orange-400 mb-3">notifications_active</span>
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 text-center">
          <span class="material-icons-outlined text-4xl text-orange-600 dark:text-orange-400 mb-3">local_offer</span>
