    ...
    @if(isset($addresses) && $addresses->count() > 0)
      ...
      <div class="mb-4 flex items-center justify-between">
        ...
        <button
          ...
          class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors flex items-center gap-1">
      ...
      <div class="space-y-3 mb-4" id="addresses-list">
        ...
        <div id="address-container-{{ $address->id }}" class="address-item">
          ...
          <label
            ...
            <!-- Address Card -->
            <div class="relative border-2 peer-checked:border-blue-600 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all p-4">

            <!-- Selected Indicator -->
            <div class="absolute top-3 right-3 w-5 h-5 border-2 border-gray-300 dark:border-gray-600 rounded-full peer-checked:border-blue-600 peer-checked:bg-blue-600 flex items-center justify-center">
            ...
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="inline-flex items-center px-2 py-1 text-xs font-medium text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30">
                Default
              </span>
              @endif
            </div>
        ...
        <div id="address-edit-{{ $address->id }}" class="hidden address-edit border-2 border-blue-300 dark:border-blue-600 bg-blue-50/50 dark:bg-blue-900/10 p-4">
      ...
      @if($addresses->count() < 3)
      <div id="new-address-form-container" class="hidden mt-4 border-2 border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-900/10 p-4">
        <div class="flex items-center justify-between mb-3">
      ...
      <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div class="flex items-start">
          <input
            ...
            class="w-4 h-4 text-blue-600 bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 mt-0.5">
              ...
              <div class="relative border-2 peer-checked:border-blue-600 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all p-3">
                ...
                <div class="pr-6">
                  <div class="flex items-center gap-2 mb-1">
                    ...
                    @if($address->is_default)
                    <span class="text-xs font-medium text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-0.5">
                      Default
                    </span>
                    @endif
                  </div>
