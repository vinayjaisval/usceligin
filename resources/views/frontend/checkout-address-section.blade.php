...
<section class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700" id="address-section">
  <div class="p-4 sm:p-6">
    ...
    @if(isset($addresses) && $addresses->count() > 0)
      ...
      <div class="space-y-3 mb-4" id="addresses-list">
        ...
        <div id="address-container-{{ $address->id }}" class="address-item">
          ...
          <label
            ...
            <!-- Address Card -->
            <div class="relative border-2 peer-checked:border-primary-600 peer-checked:bg-primary-100 dark:peer-checked:bg-primary-900/20 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all p-4">

            <!-- Selected Indicator -->
            <div class="absolute top-3 right-3 w-5 h-5 border-2 border-gray-300 dark:border-gray-600 rounded-full peer-checked:border-primary-600 peer-checked:bg-primary-600 flex items-center justify-center">
            ...
            <div class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 flex flex-wrap gap-3 text-xs">
              ...
              <button
                ...
                class="text-primary-700 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 font-medium">
                Set as default
              </button>
              @endif
        ...
        <div id="address-edit-{{ $address->id }}" class="hidden address-edit border-2 border-primary-300 dark:border-primary-600 bg-primary-100/50 dark:bg-primary-900/10 p-4">
      ...
      @if($addresses->count() < 3)
      <div id="new-address-form-container" class="hidden mt-4 border-2 border-primary-200 dark:border-primary-800 bg-primary-100/50 dark:bg-primary-900/10 p-4">
        <div class="flex items-center justify-between mb-3">
      ...
      <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div class="flex items-start">
          <input
            ...
            class="w-4 h-4 text-primary-700 bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-primary-600 mt-0.5">
        ...
        <div id="billing-address-section" class="hidden mt-4 p-4 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
          ...
          <div class="space-y-3">
            ...
            <label
              ...
              <div class="relative border-2 peer-checked:border-primary-600 peer-checked:bg-primary-100 dark:peer-checked:bg-primary-900/20 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all p-3">

                <!-- Selected Indicator -->
                <div class="absolute top-2 right-2 w-4 h-4 border-2 border-gray-300 dark:border-gray-600 rounded-full peer-checked:border-primary-600 peer-checked:bg-primary-600 flex items-center justify-center">
