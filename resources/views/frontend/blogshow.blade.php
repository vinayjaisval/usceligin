  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <article class="max-w-4xl mx-auto" itemscope itemtype="https://schema.org/BlogPosting">
      ...
      <header class="mb-8 lg:mb-12">
        <!-- Category Tag -->
        <div class="mb-4">
          <span class="inline-block px-3 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 text-sm font-semibold">Skin Care</span>
        </div>
      ...
      <footer class="border-t border-gray-200 dark:border-gray-700 pt-8 space-y-8">
        ...
        <div>
          ...
          <div class="flex gap-3">
            ...
            <a href="#" class="flex items-center justify-center w-10 h-10 bg-sky-500 text-white hover:bg-sky-600 transition-colors duration-200" aria-label="Share on Twitter">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
