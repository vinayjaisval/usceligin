        ...
        <div class="sign-in-section" id="signInSection">
          ...
          <form id="signInForm" novalidate aria-labelledby="signin-heading" role="form">
            ...
            <div class="mb-6" id="phoneGroup">
              ...
              <div class="hidden mt-2 flex items-start space-x-3 bg-red-50 dark:bg-red-50 border border-red-200 p-3" id="phoneError" role="alert" aria-live="assertive">
            ...
            <div class="mb-6 hidden" id="emailGroup">
              <label for="emailAddress" class="block text-sm font-semibold text-gray-900 dark:text-gray-900 mb-2">
              ...
              <p class="mt-2 text-xs text-gray-900 dark:text-gray-900" id="emailHelp">
                We'll send a secure OTP to your email address for verification.
              </p>
              <div class="hidden mt-2 flex items-start space-x-3 bg-red-50 dark:bg-red-50 border border-red-200 p-3" id="emailError" role="alert" aria-live="assertive">
                <svg class="w-5 h-5 text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd"
                    d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                    clip-rule="evenodd"></path>
