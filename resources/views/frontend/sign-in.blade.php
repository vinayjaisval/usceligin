...
<html lang="en">
  <head>
    ...
    />
    <meta name="keywords" content="CELIGIN login, account sign in, OTP verification, secure login, beauty account, skincare login" />
          ...
          <article class="sign-in-card">
            ...
            <header class="sign-in-logo">
              <img
                ...
                alt="CELIGIN - Premium Beauty & Skincare"
                class="sign-in-logo-img"
                width="120"
                height="40"
              />
            </header>
            ...
            <section class="sign-in-section" id="signInSection" aria-labelledby="signin-heading">
              ...
              <form class="sign-in-form" id="signInForm" novalidate aria-labelledby="signin-heading">
                ...
                <button
                  type="submit"
                  class="btn btn-accent-primary btn-full"
                  id="sendOtpBtn"
                  disabled
                >
                  Send OTP
              ...
              <form class="otp-form" id="otpForm" novalidate aria-labelledby="otp-heading">
                <div class="form-group">
                  ...
                  <input
                    ...
                    inputmode="numeric"
                    pattern="[0-9]{6}"
                    aria-describedby="otpSubtitle otpError"
                    aria-invalid="false"
                  />
    ...
    <script>
      class SignInPage {
        ...
        showOtpSection() {
          ...
          otpSubtitle.textContent = `We've sent a 6-digit code to your ${
            this.currentMethod === "phone" ? "phone number" : "email"
          } ${contactDisplay}`;
