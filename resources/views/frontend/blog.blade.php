                  ...
                  <div class="col-md-4">
                     <div class="thumb-blog-horizontal clearfix hover-img-zoom transation mb-30">
                        ...
                        <div class="post-content py-2">
                           ...
                           <h4 class="mb-2"><a href="{{ route('front.blogshow',$blog->slug) }}" class="transation text-dark hover-text-primary d-block">
                              {{ $blog->title }}</a>
                           </h4>
                           {{-- <p>{!! mb_strlen($blog->details,'UTF-8') > 200 ? mb_substr($blog->details,0,200,'UTF-8')."..":$blog->details !!}</p> --}}
                           <div class="date font-small text-uppercase"><span>Author: Celiginglobal  {{ date('M-d-Y',(strtotime($blog->created_at))) }}</span></div>
                        </div>
                     </div>
                  </div>
               @endforeach
               <div class="col-lg-12 mt-3">
                  <div class="d-flex justify-content-center align-items-center pt-3 pb-4" id="custom-pagination">
