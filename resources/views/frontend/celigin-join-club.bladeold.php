            ...
            <div class="row">
               <div class="col-lg-6">
                  <div class="shop-now-lady ">
                     ...
                     <h2 class="px-3 d-flex justify-content-center align-items-center gap-5 pb-2">Your Celigin <span class="mt-2"><a href="{{ route('front.join-now-club') }}"> Join Now </a></span></h2>
            ...
            <div class="col-lg-3">
               <div class="join-recently-title-update text-end">
                  <a href=" {{ route('front.join-now-club') }}">
                     <button class="px-3 fw-bold text-uppercase text-white">join Now</button></a>
               </div>
            </div>
         </div>
      </div>
...
<section>
   <div class="register-demand-title mt-5 ">
      <div class="container">
         <div class="gift-point-earn d-flex gap-5 py-5">
...
<!-- ==================================================instagram===================================================== -->
<section>
   <div class="instagram-title pb-5 mt-2">
      <div class="">
         <div class="row">
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
               <div class="insta-text text-center pt-3">
