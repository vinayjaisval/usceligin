    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 mb-16">
      ...
      <nav aria-label="Breadcrumb" class="mb-6">
        <ol class="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
          <li>
            <a href="index.html"
              class="hover:text-gray-900 dark:hover:text-gray-100 transition-colors duration-200">Home</a>
          </li>
      ...
      <!-- Loading Spinner -->
      <div
        class="hidden fixed inset-0 bg-white dark:bg-gray-900 bg-opacity-90 dark:bg-opacity-90 z-50 flex items-center justify-center"
        id="loading-section">
