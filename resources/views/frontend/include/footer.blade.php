      ...
      <div class="space-y-4">
        ...
        <form class="space-y-3" aria-label="Newsletter signup">
          <input type="email" placeholder="Enter your email address" required aria-label="Email address"
            class="w-full max-w-full px-3 py-2 border border-gray-300 dark:border-gray-600  text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 transition-colors duration-200 min-w-0" />
          <button type="submit"
            class="w-full bg-primary-600 hover:bg-primary-700 focus:ring-primary-600 dark:focus:ring-primary-400 text-white px-4 py-2  text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900 transition-colors duration-200">Subscribe</button>
        </form>
      </div>
    </div>
          ...
          <div
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400 flex-shrink-0">
              <p>&copy; {{ date('Y') }} CELIGIN • Powered by <a href="https://www.hucpl.com/" target="_blank"
                  ...
                  class="text-gray-900 dark:text-gray-100 hover:text-primary-700 dark:hover:text-primary-400 transition-colors duration-200 font-medium">HUCPL</a>
              </p>
            </div>
            ...
            <div class="flex items-center justify-start space-x-3 flex-shrink-0">
              @foreach(DB::table('social_links')->where('user_id', 0)->where('status', 1)->get() as $link)
                <a href="{{ $link->link }}" target="_blank" rel="noopener noreferrer"
                  class="text-gray-600 dark:text-gray-400 hover:text-primary-700 dark:hover:text-primary-400 transition-colors duration-200"
...
<script>
  ...
  function performSearch(query, products, suggestionsList, dropdown) {
    ...
    if (filteredProducts.length > 0) {
      filteredProducts.forEach(product => {
        ...
        currentPrice.className = 'text-sm font-semibold text-primary-700 dark:text-primary-400';
      ...
      viewAllItem.className = 'flex items-center justify-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-sm font-medium border-t border-gray-200 dark:border-gray-600 text-primary-700 dark:text-primary-400 transition-colors duration-200';
  ...
  function createMobileSearchOverlay() {
    ...
    searchInput.className = 'w-full px-4 py-3 border border-gray-300 dark:border-gray-600  text-sm focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400';

    const searchBtn = document.createElement('button');
    searchBtn.type = 'submit';
    searchBtn.className = 'w-full mt-3 px-4 py-3 bg-primary-600 text-white  hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 font-medium';
