        ...
        <div class="grid grid-cols-3 items-center h-20">
            ...
            <div class="w-full max-w-xs">
              <form role="search" aria-label="Site search" onsubmit="return false;" class="relative">
                <input type="search" id="search-input" placeholder="Find your perfect skincare..." aria-label="Search for products"
                  ...
                  class="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors duration-200 rounded-md" />
                ...
                <!-- Search Dropdown -->
                <div
                  class="search-dropdown absolute top-full left-0 right-0 mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-md shadow-lg hidden z-50 max-h-96 overflow-y-auto"
          ...
          <div class="flex items-center justify-end space-x-3">
            ...
            <a href="{{ route('sign-in') }}"
              class="p-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 rounded-md transition-colors duration-200"
            ...
            <a href="{{ route('front.wishlist') }}"
              class="relative p-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 rounded-md transition-colors duration-200"
              aria-label="Wishlist">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
              </svg>
              <span id="wishlist-count"
                class="absolute -top-1 -right-1 bg-orange-600 dark:bg-orange-500 text-white text-xs h-5 w-5 flex items-center justify-center rounded-full"
      ...
      <div class="lg:hidden">
        ...
        <div class="flex items-center justify-between h-14">
          ...
          <div class="flex items-center space-x-1">
            ...
            <a href="{{ route('sign-in') }}"
              class="p-2.5 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 rounded-md transition-colors duration-200 touch-manipulation"
              aria-label="My account">
            ...
            <!-- Wishlist -->
            <a href="{{ route('front.wishlist') }}"
              class="relative p-2.5 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 rounded-md transition-colors duration-200 touch-manipulation"
              aria-label="Wishlist">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
              </svg>
              <span id="wishlist-count-mobile"
                class="absolute top-0.5 right-0.5 bg-orange-600 dark:bg-orange-500 text-white text-xs h-4 w-4 flex items-center justify-center rounded-full font-medium"
                aria-label="{{ Session::has('wishlist') ? count(Session::get('wishlist')) : '0' }} items in wishlist">
                {{ Session::has('wishlist') ? count(Session::get('wishlist')) : '0' }}
              </span>
            </a>
