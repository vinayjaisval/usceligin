    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg5">
                <div class="left">
                    ...
                    <span class="number">{{
                        App\Models\Order::where('seller_id','=',$user->id)->where('status','=','completed')->sum('totalQty')
                        }}</span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    @php
                    $discountOrCalculation=0;
                    $datas = App\Models\Order::where('seller_id',Auth::user()->id);
                    $totalPrice =$datas->count() > 0 ? $datas->sum('pay_amount') : 0;
                    $amount= (float) App\Models\Product::vendorConvertPrice($totalPrice);
                 
                
                    if($totalPrice > 20000){
                    $discountOrCalculation = $totalPrice * 0.05;
                
                    }else{
                    $discountOrCalculation = $totalPrice * 0.02;
                    }
                    ...
                    <span class="number">{{ $discountOrCalculation}}</span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-dollar-true"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    ...
                    $totalTeam =$datas->count('seller_id') ? $datas->count('seller_id') : 0;
                    ...
                    <span class="number">{{ $totalTeam}}</span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-dollar-true"></i>
                        ...
                        <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-list"><a href="{{ route('vendor-order-show',$data->id) }}"><i class="fas fa-eye"></i> {{ __('Details') }}</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
