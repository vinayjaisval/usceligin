...
(function($) {
  ...
  function number_format (number, decimals, dec_point, thousands_sep) {
    ...
    $(document).on("click", "#qaddcrt" , function(){
     ...
     window.location = mainurl+"/vendor/order/updatecart/"+order_id+"?id="+pid+"&qty="+qty+"&size="+sizes+"&color="+colors.substring(1, colors.length)+"&size_qty="+size_qty+"&size_price="+size_price+"&size_key="+size_key+"&keys="+keys+"&values="+values+"&prices="+prices+"&item_id="+item_id;
