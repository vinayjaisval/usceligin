            ...
            <div class="col-lg-6">
                <div class="special-box">
                    <div class="heading-area">
                        <h4 class="title">
                            {{ __('Order Details') }}
                            @if(@App\Models\DeliveryRider::where('vendor_id',auth()->id())->where('order_id',$order->id)->first()->status
                            == 'delivered' &&
                            $order->vendororders()->where('status','completed')->count()
                            == 0)
                            <a href="{{route(" vendor-order-status",["id1"=> $order->order_number, "status" =>
                                "completed"])}}" class="mybtn1">@lang('Make Complete')</a>
                            @endif
                        </h4>
                    </div>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="45%">
                                        {{ \PriceHelper::showOrderCurrencyPrice(($price *
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p>
                                            ...
                                            {{ \PriceHelper::showOrderCurrencyPrice(($product['item_price'] *
                                            $order->currency_value),$order->currency_sign) }}
                                        </p>
                                        <p>
                                    ...
                                    <td>
                                        {{ \PriceHelper::showOrderCurrencyPrice(($product['price'] *
                                        $order->currency_value),$order->currency_sign) }} <small>{{ $product['discount']
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{route('vendor-order-license',$order->order_number)}}" id="edit-license"
                    style="display: none;">
                    {{csrf_field()}}
                    ...
                    <div class="form-group text-center">
                        ...
                        <input type="submit" name="submit" value="{{ __('Save License') }}" class="btn btn-primary"
