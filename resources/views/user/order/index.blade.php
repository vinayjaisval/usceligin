    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
               ...
               <i class="fas fa-shopping-bag me-2"></i>{{ __('Purchased Items') }}
            </h4> -->
                            <h4 class="widget-title down-line mb-30"> <i class="fas fa-shopping-bag me-2"></i>{{ __('Purchased Items') }}</h4>
                            <div class="table-responsive">
                                <table class="table table-hover align-middle table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \PriceHelper::showAdminCurrencyPrice(($order->pay_amount), $order->currency_sign) }}</td>
                                            <td>
                                                <span class="badge 
                              ...
                              @else bg-secondary @endif">
                                            ...
                                            <td>
                                                <a href="{{ route('user-order', $order->id) }}" class="btn btn-sm ">
