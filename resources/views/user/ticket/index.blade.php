               ...
               <div class="col-lg-12">
                  <div class="card shadow-sm border-0 p-4 bg-white rounded-3">
                     <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="javascript:;" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#vendorform">
                           <i class="fas fa-plus me-1"></i> {{ __('Add Ticket') }}
                        </a>
                     </div>
                     ...
                     <div class="table-responsive">
                        <table class="table table-hover table-bordered align-middle">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <input type="hidden" value="{{ $conv->id }}">
                                 <td>{{ Str::limit($conv->subject, 40) }}</td>
                                 <td>{{ Str::limit($conv->message, 50) }}</td>
                                 <td>{{ $conv->created_at->diffForHumans() }}</td>
                                 <td class="text-center">
                                    <a href="{{ route('user-message-show', $conv->id) }}" class="btn btn-sm  me-1" title="View">
                                       <i class="fa fa-eye"></i>
                                    </a>
