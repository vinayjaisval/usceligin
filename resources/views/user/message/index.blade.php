...
{{-- <div class="full-row bg-light overlay-dark py-5"
  ...
  <div class="container">
    <div class="row text-center text-white">
      <div class="col-12">
        <h3 class="mb-2 text-white">{{ __('Messages') }}
                    ...
                    <tbody>
                      ...
                      <tr class="conv">
                        ...
                        <td data-label="{{ __('Actions') }}">
                          <div>
                            <a href="{{route('user-message',$conv->id)}}" class="link view mybtn1"><i
                                class="fa fa-eye"></i></a>
                            <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#confirm-delete"
                              data-href="{{route('user-message-delete',$conv->id)}}" class="link remove mybtn1"><i
