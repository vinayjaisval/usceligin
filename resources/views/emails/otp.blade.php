...
<head>
  ...
  <style>
    ...
    @media only screen and (max-width: 600px) {
      ...
      .cta-td { width: 100% !important; text-align: center !important; }
      .cta-link { display: block !important; text-align: center !important; padding: 16px 24px !important; }

      /* Footer: reduce padding */
      .footer-td { padding: 20px 24px 24px 24px !important; }
    }
  </style>
</head>
