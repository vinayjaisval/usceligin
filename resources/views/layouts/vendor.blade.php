						...
						<div class="right-eliment">
							<ul class="list">
								...
								<li class="login-profile-area">
									...
									$photoPath = 'assets/images/noimage.png';

									if ($user->photo) {
									
										$photoPath = $user->is_provider == 1
											? asset($user->photo)
											: asset('assets/images/users/' . $user->photo);
									} else {
										
										$photoPath = asset('assets/images/noimage.png');
									}
								@endphp

								<div class="user-img">
									<img src="{{ $photoPath }}" alt="User Image">
								</div>
					...
					<ul class="list-unstyled components" id="accordion">
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="order" data-parent="#accordion">
								...
								<li>
								<a href="{{route('vendor-order-create')}}"> {{ __('Pos') }}</a>
								</li>
							</ul>
						</li>
						<!-- <li>
						...
						<li>
							<a href="{{ route('vendor-mlm-users') }}" class="wave-effect"><i
