                    ...
                    <div class="product-description">
                      ...
                      @include('alerts.admin.form-both')
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title" placeholder="{{ __('Add title here') }}" required="" value="{{$data->title}}">
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="up_sale" placeholder="{{ __('Up To Sale') }}" required="" value="{{$data->up_sale}}">
                          </div>
                        </div>
