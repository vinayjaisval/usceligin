...
@section('content')
		<div class="content-area">
			<div class="mr-breadcrumb">
				<div class="row">
					<div class="col-lg-12">
							<h4 class="heading">{{ __('Physical Product') }} <a class="add-btn" href="{{ route('admin-prod-types-kr') }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
							<ul class="links">
								<li>
							...
							<li>
								<a href="{{ route('admin-prod-index-kr') }}">{{ __('All Products') }}</a>
							</li>
								<li>
									<a href="{{ route('admin-prod-types-kr') }}">{{ __('Add Product') }}</a>
								</li>
								<li>
									<a href="{{ route('admin-prod-create-kr','physical') }}">{{ __('Physical Product') }}</a>
								</li>
							</ul>
					</div>
				</div>
			</div>
			<form id="geniusform" action="{{route('admin-prod-store-kr')}}" method="POST" enctype="multipart/form-data">
				{{csrf_field()}}
										...
										<div class="body-area">
											...
											<div class="row">
												...
												<div class="col-lg-12">
													...
													<input type="hidden" class="input-field"  name="language" required="" value="kr">
