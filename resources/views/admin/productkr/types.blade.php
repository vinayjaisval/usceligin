...
<div class="content-area">
            ...
            <div class="add-product-content">
              ...
              <div class="ap-product-categories">
                <div class="row">
                  <div class="col-lg-4">
                    <a href="{{ route('admin-prod-create-kr','physical') }}">
                  ...
                  <div class="col-lg-4">
                    <a href="{{ route('admin-prod-create-kr','digital') }}">
                  ...
                  <div class="col-lg-4">
                    <a href="{{ route('admin-prod-create-kr','license') }}">
                ...
                <div class="row my-4 d-flex justify-content-center">
                  <div class="col-lg-4">
                    <a href="{{ route('admin-prod-create-kr','listing') }}">
                    <div class="cat-box box3">
                      <div class="icon">
