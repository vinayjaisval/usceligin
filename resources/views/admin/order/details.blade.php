                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th width="10%">:</th>
                                    <td width="45%">{{$order->billing_country_id}}</td>
                                </tr>
                               
                                <tr>
                                    <th width="45%">{{ __('State') }}</th>
                                    <th width="10%">:</th>
                                    <td width="45%">{{$order->billing_state_id}}</td>
                                </tr>
                            
                                <tr>
                                    <th width="45%">{{ __('City') }}</th>
                                    <th width="10%">:</th>
                                    <td width="45%">{{$order->billing_city}}</td>
                                </tr>
                                <tr>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th width="10%">:</th>
                                    <td width="45%">{{$order->shipping_country_id }}</td>
                                </tr>
                                ...
                                <tr>
                                    <th width="45%">{{ __('State') }}</th>
                                    <th width="10%">:</th>
                                    <td width="45%">{{$order->shipping_state_id }}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <th width="10%">:</th>
                                    <td width="45%">{{$order->shipping_city }}</td>
                                </tr>
                                <tr>
