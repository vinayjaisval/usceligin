...
@if ($isUser == 1)
  <div class="row mt-2">
    ...
    <textarea  type="text" class="form-control"  name="customer_address" id="customer_address" placeholder="Address">{{$user['address']}}</textarea>
    </div>
  </div>
  <div class="row">
    <div class="col col-md-6 col-sm-6">
...
@else
  ...
  <div class="row mt-2">
   ...
   <textarea  type="text"  class="form-control" required name="customer_address" placeholder="Address" id="customer_address"></textarea>
