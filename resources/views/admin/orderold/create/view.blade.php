                  ...
                  <table class="table">
                     <tbody>
                        ...
                        <tr>
                           ...
                           <th width="10%">:</th>
                           <td width="45%" id="total">{{App\Models\Product::convertPrice($cart->totalPrice)}}</td>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="{{route('admin-order-create-submit')}}" class="mybtn1" id="submitButton" onclick="disableButton()">Order Submit</a>
                           </td>
