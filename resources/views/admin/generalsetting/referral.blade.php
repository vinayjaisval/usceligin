                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-gs-affilate') }}">{{ __('Referral Program') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Referral Amount') }}</h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                    <div class="img-upload">
                                        <div id="image-preview" class="img-preview text-center" style="background: url({{ $gs->affilate_banner ? asset('assets/images/'.$gs->affilate_banner):asset('assets/images/noimage.png') }});">
                                            ...
                                            <input type="file" name="referral_banner" class="img-upload">
                                          </div>
                                    </div>
