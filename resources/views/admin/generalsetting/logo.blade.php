...
@section('content')
          ...
          <div class="content-area">
            ...
            <div class="add-logo-area">
              ...
              <div class="row justify-content-center">
                <div class="col-xl-4 col-md-6">
                  ...
                  @include('alerts.admin.form-both')  
                         ...
                         <img src="{{ $gs->logo ? url('/assets/images/'.$gs->logo) : url('/assets/images/noimage.png') }}" alt="">                          </div>
                          <div class="set-logo">
              ...
              @include('alerts.admin.form-both')  
                        <div class="currrent-logo">
                          <img src="{{ $gs->footer_logo ? url('/assets/images/'.$gs->footer_logo) : url('/assets/images/noimage.png') }}" alt="">
                        </div>
                        <div class="set-logo">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box  bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="currrent-logo">
                            <img src="{{ $gs->invoice_logo ? url('/assets/images/'.$gs->invoice_logo) : url('/assets/images/noimage.png') }}" alt="">
                          </div>
