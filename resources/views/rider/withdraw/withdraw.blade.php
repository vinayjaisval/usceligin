            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="widget border-0 p-40 widget_categories bg-light account-info">
                     ...
                     <form id="userform" class="form-horizontal" action="{{route('rider-wwt-store')}}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @include('alerts.admin.form-both')
                        <div class="form-group mb-4">
                           <label class="control-label col-sm-4" for="name">{{ __('Current Balance') }}
                              {{ App\Models\Product::vendorConvertPrice(Auth::guard('rider')->user()->balance) }}</label>
                        </div>
                        ...
                        <div class="form-group">
                           <label class="control-label col-sm-12 mb-2" for="name">{{ __('Additional
                              Reference(Optional)') }} *
                           </label>
                           <div class="col-sm-12">
